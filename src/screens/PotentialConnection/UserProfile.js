...
class UserProfile extends React.Component {
  ...
  getUserDetails(userid) {
    ...
    Api.getApi('user/'+userid, this.props.data.token).then(userDetailsRes => {
  ...
  render() {
    ...
    return (
      <>
      { this.state.connections ? <Connections navigation ={this.props.navigation} userId={this.props.userId}/> : 
      this.state.potentialConnections ? <PotentialConnection navigation ={this.props.navigation} userId={this.props.userId}/> :
      this.state.topConnections ? <TopConnection navigation ={this.props.navigation} userId={this.props.userId}/> :

      <View style={[styles.containerProfile], { position: 'relative' }}>
